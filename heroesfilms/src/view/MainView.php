 ...
 */
	...
	public function about(){
		...
		$this->content .= "<ul><li>Find poster and background with TMDB API (id of films is a 6 numbers chains availaible in the url of the movie on their website)[/!\It seems to not work on the university servers... It's making the tab charging and nothing more happends... And when you go back to the menu the film is correctly added, just background and poster were not recup... It's working good on local.</li><li>JS script to add between 3 and 8 actors per movie</li><li>Various displays of lists (per universe, per member)</li><li>CSS created trying to respect the Google style</li><li>CSS which change with pages (Marvel/DC/Others)</li><li>We have create fab style button for go back to the, delete, update or create a film, they're accessible anytime in the right corner</li><li>With first connexion, a pop-up appears to prevent for uses of cookies.</li><li>Login and Register</li><li>Clik on a card in film list will show you more information about it with JS</li><li>Half responsive site (some problems persists)</li><li>If a film have been modified we only show the modification date otherwise we display the creation date</li></ul>";
	}

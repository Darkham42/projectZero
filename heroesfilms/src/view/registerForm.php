...
<div class="card">
    ...
    <img src="assets/logIn.jpg" alt="Register" class="full" />
    <form method="POST" action='#'>
        <div class="form-group">
            <input id="pseudo" spellcheck=false class="form-control" name="pseudo" type="text" size="20" required="">
        ...
        <div class="form-group">
            <input id="password" class="form-control" spellcheck=false name="password" type="password" size="20" minlength="4" maxlength="8" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).{4,8}$" title="Votre mot de passe doit contenir entre 4 et 8 caractères dont au moins une minuscule, une majuscule et un chiffre." required="">
            <span class="form-highlight"></span>
            <span class="form-bar"></span>
            <label class="float-label">Password</label>
        </div>
        <div class="form-group">
            <button type="submit" value="Valider" name="submit">Sign up</button>
        </div>
    </form>

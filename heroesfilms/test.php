...
if(isset($_POST['submit'])) {
  ...
  $filmData = file_get_contents('http://api.themoviedb.org/3/movie/'.$film.'?api_key=0d54fe0f0576cb6a08751326b1ec4a98&language=fr&include_image_language=fr,null');
  ...
  echo "Affiche : <br><img src=".$affiche.">";
